...
public class Runner2 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        StaticNestedClassExample.Person person = obj.new Person();
        person.setName("煎蛋");
        person.setAge(1);
        StaticNestedClassExample.Person person2 = obj.new Person();
        person2.setName("大骚");
        person2.setAge(2);
        StaticNestedClassExample.Person person3 = obj.new Person();
